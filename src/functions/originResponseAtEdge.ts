...
exports.handler = async (event: any, context: any, callback: any) => {
  ...
  if (response.status == 200) {
    ...
    let key = decodeURIComponent(request.origin.s3.path + request.uri).substring(1)
    console.log('key: ', key)
  ...
  function responseUpdate (status: any, statusDescription: any, body: any, contentHeader: any, bodyEncoding: any = undefined) {
